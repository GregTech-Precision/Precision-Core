...
public class ParallelComputerRack extends MetaTileEntityMultiblockPart {
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        return ModularUI.builder(GTWPGuiTextures.PARALLEL_RACK_GUI, 176, 166)
                .label(10, 5, getMetaFullName())
                .slot(inventory, 0, 68, 27, GuiTextures.SLOT, GTWPGuiTextures.RACK_SLOT)
                .slot(inventory, 1, 90, 27, GuiTextures.SLOT, GTWPGuiTextures.RACK_SLOT)
                .slot(inventory, 2, 68, 49, GuiTextures.SLOT, GTWPGuiTextures.RACK_SLOT)
                .slot(inventory, 3, 90, 49, GuiTextures.SLOT, GTWPGuiTextures.RACK_SLOT)
