package precisioncore.common.metatileentities.multi.multiblockparts;
...
public class MEItemOutputHatch extends MetaTileEntityItemBus {

    private IActionSource source;
    private AENetworkProxy proxy;

    public MEItemOutputHatch(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, 5, true);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MEItemOutputHatch(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("precisioncore.multi.meitemoutputhatch"));
    }
}