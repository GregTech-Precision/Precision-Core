...
public class ReactorSteamHatch  extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IFluidTank>, IControllable {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new ReactorSteamHatch(metaTileEntityId, getInventorySize(), isExportHatch);
    }
