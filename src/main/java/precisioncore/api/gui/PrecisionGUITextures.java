...
public class PrecisionGUITextures {
    ...
    public static final TextureArea ROD_HATCH_BACKGROUND = TextureArea.fullImage("textures/gui/rod_hatch_background.png");

    public static final TextureArea ROD_LEVEL = TextureArea.fullImage("textures/gui/rod_level.png");
}
